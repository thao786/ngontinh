...
(defroutes app-routes
        (HEAD "/" [] "")
        (GET "/bootstrap.css" [] (io/resource "bootstrap.css"))
        (GET "/bootstrap-collapse.js" [] (io/resource "bootstrap-example/js/bootstrap-collapse.js"))
        (GET "/jquery.css" [] (io/resource "jquery.js"))
        (GET "/bootstrap-theme.css" [] (io/resource "bootstrap-theme.css"))
        (GET "/docs.css" [] (io/resource "bootstrap-example/docs/assets/css/docs.css"))
        (GET "/bootstrap-responsive.css" [] (io/resource "bootstrap-responsive.css"))
        (GET "/style1.css" [] (io/resource "style1.css"))
        (GET "/style2.css" [] (io/resource "style2.css"))
